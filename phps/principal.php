 ...
 <br><br>
    ...
    <div id="test5" class="col s12">
      <table id="demo" class="responsive-table bordered highlight">
        <thead  >
          <tr >
            <th width="700" align="center"  data-field="id">Nombre(s) del Cliente</th>
            <th width="200" align="center"  data-field="name">Tipo de Junta</th>
            <th width="300" align="center"  data-field="price">Expediente</th>
            <th width="300" align="center"  data-field="id">Nombre de Contrario</th>
            <th width="300" align="center"  data-field="id">Fecha de Demanda</th>
            <th width="300" align="center"  data-field="id">Tipo de Demanda</th>
            <th width="700" align="center" data-field="id">Estado Procesal</th>
            <th width="500" align="center"  data-field="id">Registro del Cliente</th>
            <th width="300" align="center"  data-field="id">Anticipo</th>
            <th width="300" align="center"  data-field="id">Vendedor</th>
            <th width="300" align="center"  data-field="id">Modificado Por</th>
            <th width="500" align="center"  data-field="id">Observaciones</th>
            <th width="50" align="center"  data-field="id">Editar</th>
          </tr>
        </thead>
        <tbody >
          ...
          <tr>
            <form action="Editar_juicio.php" method="POST">
              <td width="700" align=center> <?php  print $fila5->nombre_cliente; ?></td>
              <td width="200" align="center"><?php  print $fila5->tipo_junta; ?></td>
              <td width="300"  align="center"><?php  print $fila5->num_expediente; ?></td>
              <td width="200"  align="center"><?php  print $fila5->nom_contrario; ?></td>
              <td width="300"  align="center"><?php  print $fila5->fecha_demanda; ?></td>
              <td width="200"  align="center"><?php  print $fila5->tipo_demanda; ?></td>
              <td width="700"  align="center"><?php  print $fila5->estado_procesal; ?></td>
              <td width="500"  align="center"><?php  print $fila5->fecha_registro_cliente; ?></td>
              <td width="300"  align="center"><?php  print $fila5->anticipo; ?></td>
              <td width="300"  align="center"><?php  print $fila5->vendedor; ?></td>
              <td width="300"  align="center"><?php  print $fila5->modificacion; ?></td>
              <td width="500"  align="center"><textarea name="anotaciones" id="anotaciones" class="textarea"  disabled="true"><?php  print $fila5->observaciones; ?></textarea></td>
