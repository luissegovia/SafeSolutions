...
?>
        ...
        <div class="card-panel z-depth-5">
          ...
          <div class="row">
            <div class="col s12 m4 l4">
              ...
              <i class="material-icons prefix">person</i><label><strong>Nombre(s) del Cliente</strong></label><input type="text"  id="nombre_cliente" value="<?php print $nombre_cliente; ?>"  name="nombre_cliente" class="validate" length="30">
            </div>
            <div class="col s12 m4 l4"><i class="material-icons prefix">account_balance</i><label for="icon_prefix2"><strong>Tipo de Junta:</strong></label><input type="text" id="junta" value="<?php print $tipo_junta; ?>"  name="junta" class="validate" length="20">
          </div><strong>
          <div class="col s12 m4 l4"><i class="material-icons prefix">explicit</i><label for="icon_prefix2"><strong>Numero de Expediente</strong></label><input type="text"  id="expediente" value="<?php print $num_expediente; ?>"  name="expediente" class="validate" length="15">
        </div>
      </div>
      <div class="row">
    ...
    <div class="row">
      <div class="col s12">
        <!-- Observaciones -->
        <div class="col s12 ">
          <i class="material-icons prefix">visibility</i><label for="icon_prefix2"><strong>Observaciones:</strong></label><textarea type="text" id="observaciones" name="observaciones" value="<?php print $observaciones; ?>"  length="500"><?php print $observaciones; ?></textarea><input type="hidden" id="id" value="<?php print $id; ?>"  name="id" class="validate">
        </div>
      </div>
    </div><br>
    <hr>
