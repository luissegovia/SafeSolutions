...
<html>
	...
	<body>
		...
		$Mysqll="UPDATE clientes,juicios SET nombres = '$nombres', apellidos = '$apellidos', telefono = '$telefono', colonia = '$colonia', calle = '$calle', numero = '$numero', email = '$email' WHERE id_cliente = $id";
