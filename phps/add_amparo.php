...
<html>
  ...
  <body class="grey lighten-2">
    ...
    <div class="row">
      <form class="col s12" action="amparos.php" method="POST">
        <div class="card-panel z-depth-5">

        <h4 align="center">Agregar un nuevo Juicio de Amparo</h4><br><br>
          
          <div class="row">
            <div class="col s12 m4 l4">
              <i class="material-icons prefix">person</i><label for="icon_prefix2"><strong> T/J:</strong></label><input type="text" id="tribunal" required="No puedes dejar ningun campo vacio" name="tribunal"  class="validate" length="30">
          </div>
          <div class="col s12 m4 l4"><i class="material-icons prefix">account_balance</i><label for="icon_prefix2"><strong>No. Amparo:</strong></label><input type="text" id="num_amparo" required="No puedes dejar ningun campo vacio" name="num_amparo"  class="validate" length="30">
      </div>
      <div class="col s12 m4 l4">
        <i class="material-icons prefix">explicit</i><label for="icon_prefix2"><strong>Quejoso:</strong></label><input type="text" id="quejoso" required="No puedes dejar ningun campo vacio" name="quejoso"   class="validate" length="30">
      </div>
    </div>
    <div class="row">
      <div class="col s12  m6">
        <i class="material-icons prefix">account_box</i><label for="icon_prefix2"><strong>Tercero:</strong></label><input type="text" id="tercero" required="No puedes dejar ningun campo vacio" name="tercero"  class="validate" length="30">
      </div>
        
         <div class="col s12  m6">
        <i class="material-icons prefix">feedback</i><label for="icon_prefix2"><strong>Responsable:</strong></label><input type="text" id="responsable" required="No puedes dejar ningun campo vacio" name="responsable"  class="validate" length="30">
      </div>

    </div>

    <div class="row">
      <div class="col s12 m4 l4"><i class="material-icons prefix">event_note</i><label for="icon_prefix2"><strong>Origen:</strong></label><input type="text" required="" id="origen" name="origen" length="30">
    </div>
    <div class="col s12 m4 l4"><i class="material-icons prefix">monetization_on</i><label for="icon_prefix2"><strong>Acto R.:</strong></label><input type="text" id="acto_r" required="No puedes dejar ningun campo vacio"  name="acto_r" class="validate" length="30">
  </div>
  <div class="col s12 m4 l4"><i class="material-icons prefix">face</i><label for="icon_prefix2"><strong>Anotaciones:</strong></label><textarea name="anotaciones" id="anotaciones" class="validate"  length="100" ></textarea>
</div>
</div>
...
<div class="row">
  ...
  <div class="col s12  m6 ">
        <i class="material-icons prefix">visibility</i><label for="icon_prefix2"><strong>Centencias:</strong></label><input type="text" id="centencia" required="No puedes dejar ningun campo vacio"  name="centencia" class="validate" length="30">
      </div>
      <div class="col s12  m6 ">
        <i class="material-icons prefix">visibility</i><label for="icon_prefix2"><strong>Pendiente:</strong></label><input type="text" id="pendiente" required="No puedes dejar ningun campo vacio"  name="pendiente" class="validate" length="30">
      </div>
