...
<html>
	...
	<body>
		...
		$insertar="INSERT INTO juicios (id_juicio, nombre_cliente, tipo_junta, num_expediente, nom_contrario, fecha_demanda, tipo_demanda, fecha_registro_cliente, anticipo, vendedor, estado_procesal, modificacion, observaciones, ultima_modificacion, id_cliente) VALUES (NULL,'{$nombre}','{$tipo_junta}','{$num_expediente}','{$nom_contrario}','{$fecha_demanda}','{$Tipo_demanda}','{$fecha_registro}','{$anticipo}','{$vendedor}','{$estado_procesal}','{$usuario}','{$obs_iniciales}','{$hoy}', $nom_cliente);";
